...
{
	printf("lnicosia's ft_traceroute version 1.0\n");
...
{
	printf("Usage: ft_traceroute [-aDfhnqvV] [-c count] [-i interval] [-s packetsize]\n");
...
{
	dprintf(STDERR_FILENO, "Usage: ft_traceroute [-aDfhnqvV] [-c count] " \
